...
#ifndef _LTRACE_FREEBSD_TRACE_H_
#define _LTRACE_FREEBSD_TRACE_H_
...
void ptrace_disable_and_singlestep(struct process_stopping_handler *self);
void ptrace_disable_and_continue(struct process_stopping_handler *self);

#endif /* _LTRACE_FREEBSD_TRACE_H_ */
